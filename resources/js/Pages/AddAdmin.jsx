...
export default function AddAdmin({ auth }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('AddAdmin.store'));
    };

    return (
        <AdminLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Admin or Agent</h2>}
        >
            <Head title="Add Admin or Agent" />
                            ...
                            <form onSubmit={submit}>
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <label className="inline-flex items-center ml-6 text-gray-200">
                                            <input
                                                type="radio"
                                                name="role"
                                                value="agent"

...
export default function AdminDashboard({ auth, customerCount, adminCount, agentCount, orderCount,totalIncome, pendingIncome }) {
                        ...
                        <div className="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="p-4 bg-green-100 dark:bg-green-900 rounded-lg shadow-md">
                                    ...
                                    <p className="text-4xl font-bold text-gray-800 dark:text-gray-200">{adminCount}</p>
                                </div>
                                ...
                                <div className="p-4 bg-purple-100 dark:bg-orange-900 rounded-lg shadow-md">

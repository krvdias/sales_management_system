                ...
                <aside className="bg-gray-800 text-white w-64 min-h-screen py-4">
                    <nav className="mt-10 space-y-2">
                        ...
                        <div>
                            ...
                            {showAdminsDropdown && (
                                <div className="ml-4 space-y-2">
                                    <SideNavLink href={route("AdminList.index")}>View Admins</SideNavLink>
                                    <SideNavLink href={route("AgentList.open")}>View Agents</SideNavLink>
                                    <SideNavLink href={route("AddAdmin.create")}>Add Admin or Agent</SideNavLink>
                                </div>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {showMaterialsDropdown && (
                                <div className="ml-4 space-y-2">
                                    <SideNavLink href={route("MaterialList.create")}>View Materials</SideNavLink>
                                    <SideNavLink href={route("AddMaterial.index")}>Add Material</SideNavLink>
                                </div>
                            )}
                        </div>
